...
public abstract class Regra {
     ...
     */
    private float valorMaximo = Float.MAX_VALUE;
     ...
     */
    private float valorMinimo = Float.MIN_VALUE;
    ...
    public Regra() {
        valorMaximo = Float.MAX_VALUE;
        valorMinimo = Float.MIN_VALUE;
    }
     ...
     */
    public abstract Valor avalie(List<? extends Avaliavel> avaliaveis,
